...
import com.futuretecnologia.gestorfinanceiro.operacoes.adapters.OperacaoAdapter
import com.futuretecnologia.gestorfinanceiro.operacoes.tasks.SetupListTask
import com.futuretecnologia.gestorfinanceiro.operacoes.tasks.SetupViewModelTask
...
class ExibirFragment : Fragment() {
    private var lista_operacoes = mutableListOf<com.futuretecnologia.gestorfinanceiro.entidades.Operacao>()

    fun setList(list:MutableList<com.futuretecnologia.gestorfinanceiro.entidades.Operacao>){
