package com.futuretecnologia.gestorfinanceiro.operacoes.adapters
...
class OperacaoAdapter (val operacoes : MutableList<com.futuretecnologia.gestorfinanceiro.entidades.Operacao>?) : RecyclerView.Adapter<OperacaoAdapter.GastoViewHolder>(){
