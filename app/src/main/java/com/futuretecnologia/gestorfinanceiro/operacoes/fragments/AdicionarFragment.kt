package com.futuretecnologia.gestorfinanceiro.operacoes.fragments
...
import com.futuretecnologia.gestorfinanceiro.operacoes.tasks.AddOperacaoTask
import com.futuretecnologia.gestorfinanceiro.operacoes.viewmodels.CategoriaViewModel
...
class AdicionarFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_Add.setOnClickListener {
            ...
            catch (ex : com.futuretecnologia.gestorfinanceiro.excecoes.InvalidOperacaoException){
    ...
    fun getMoeda(){
        ...
        retrofit.create(com.futuretecnologia.gestorfinanceiro.api.CotacaoService::class.java).converterMoeda().enqueue(object :
            Callback<com.futuretecnologia.gestorfinanceiro.entidades.Cotacao> {
            override fun onFailure(call: Call<com.futuretecnologia.gestorfinanceiro.entidades.Cotacao>, t: Throwable) {
                Toast.makeText(requireContext(), t.message,Toast.LENGTH_LONG).show()
            }

            override fun onResponse(call: Call<com.futuretecnologia.gestorfinanceiro.entidades.Cotacao>, response: Response<com.futuretecnologia.gestorfinanceiro.entidades.Cotacao>) {
