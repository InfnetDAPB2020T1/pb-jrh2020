package com.futuretecnologia.gestorfinanceiro.categorias.adapter
...
import com.futuretecnologia.gestorfinanceiro.OperacoesActivity
import com.futuretecnologia.gestorfinanceiro.R
import kotlinx.android.synthetic.main.categoria_recycler.view.*

class CategoriaAdapter(val categorias : MutableList<com.futuretecnologia.gestorfinanceiro.entidades.Categoria>, val context:Context) : RecyclerView.Adapter<CategoriaAdapter.CategoriaViewHolder>(){
